...
public:
  trackBallCamera(const std::string& name) : camera(name), rho(0.0), theta(0.0), phi(90.0) { }
  trackBallCamera(const std::string& name, const glm::mat4& projection, const glm::mat4& view) : camera(name, projection, view),
									    rho(0.0), theta(0.0), phi(90.0) { }
  trackBallCamera(const std::string& name, const glm::vec3& pos, const glm::vec3& target, const glm::vec3& upVector,
